...
public class Main {
            ...
            // ================= LOGIN =================
                ...
                if (loginUser != null) {
                    ...
                    do {
                        ...
                        System.out.println("5. Reports & Audit Module");
                        System.out.println("6. Supplier & Purchase Management ");
                        System.out.println( "7. Sales & Customer Management");
    ...
    if (pChoice == 1) {
        ...
        auditService.logAction(
                currentUser,
                "Generated Payroll Payslip for Employee ID : "
                        + employeeId
        );
